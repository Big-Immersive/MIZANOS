...
DEFAULT_PROMPTS: dict[str, str] = {
    "chat": (
        ...
        "- Never mix roles in the answer. If the user asked about engineers, "
        "do NOT include project_manager / operations / marketing / etc.\n"
        "- Never say 'I don't have a real-time view' — the workload block IS "
        "real-time; answer from it. Name the specific people and their active "
        "task counts.\n\n"
